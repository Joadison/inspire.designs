...
function Pacotes() {
  ...
  return (
    <div className="md:max-w-7xl md:p-8 container mx-auto items-center">
      <h1 className="text-7xl font-greatVibes text-center text-gray-900 mb-12">
        Nossos Pacotes
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        {packages.map((pkg, index) => (
          <div
            ...
            onClick={() =>
              sendMessage(`Olá, tenho interesse no Pacote ${pkg.title}.`)
            }
          >
            <div className="text-center">
              {pkg.icon}
              <h2 className="text-2xl font-arsenica font-bold text-gray-900 mb-4">
                {pkg.title}
              </h2>
              ...
              <p className="text-center text-xl font-serif font-bold text-gray-800 mt-8">
                {pkg.price}
              </p>
            </div>
          </div>
      ...
      <div className="text-center mt-16">
        ...
        <p className="text-lg text-gray-600">
          Escolha o pacote perfeito para seu negócio e vamos juntos alcançar
          novos patamares.
        </p>
        <button
          onClick={() =>
            sendMessage("Olá, gostaria de saber mais sobre os pacotes.")
          }
