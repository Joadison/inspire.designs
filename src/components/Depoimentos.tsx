...
const depoimentos = [
  ...
  },
  {
    ...
    inst: 'dannyleite4',
    imagem: '/daniele.png',
    texto: 'Excelente! O serviço prestado foi impecável e os resultados superaram nossas expectativas. Agradecemos a dedicação e compromisso...',
  },
  {
    id: 5,
    nome: 'João Pedro',
...
const Depoimentos = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-8">
      <h1 className="text-7xl font-greatVibes text-center text-black mb-6">Depoimentos</h1>
            ...
            >
              <div className="text-center bg-gray-50 rounded-md p-8">
                ...
                <div className='flex justify-center mt-8'>
                  <span className='font-semibold text-2xl'>{depoimento.nome}</span>
                  <a 
                ...
                <p className="mt-4 text-xl mx-9">{depoimento.texto}</p>
              </div>
            </div>
          ))}
        </div>
